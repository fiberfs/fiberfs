...
#define FBR_FIBERFS_CACHE			"cache"
#define FBR_FIBERFS_META			"meta"
...
#define FBR_FIBERFS_CACHE_NAME			FBR_FIBERFS_NAME FBR_FIBERFS_CACHE
#define FBR_FIBERFS_META_NAME			FBR_FIBERFS_NAME FBR_FIBERFS_META
#define FBR_CSTORE_CROOT_LEN			512
#define FBR_CSTORE_HASHPATH_LEN			(FBR_CSTORE_CROOT_LEN + 128)

#define FBR_ENUM_CSTORE_FILE_TYPE						\
	FBR_ENUM_NAMES(fbr_cstore_file_type, fbr_cstore_type_name)		\
