...
FBR_TEST_CMD(sys_ls)
FBR_TEST_CMD(sys_ls_error)
FBR_TEST_CMD(sys_cat)
FBR_TEST_CMD(sys_cat_md5)
FBR_TEST_CMD(sys_cat_error)
FBR_TEST_CMD(sys_stat_size)
FBR_TEST_CMD(sys_stat_mode)
FBR_TEST_CMD(sys_stat_uid)
FBR_TEST_CMD(sys_write)
FBR_TEST_CMD(sys_append)
FBR_TEST_CMD(sys_write_exclusive)
FBR_TEST_CMD(sys_write_sync)
