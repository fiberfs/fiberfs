...
static void
_json_writer_init(struct fbr_json_writer *json) {
	assert_dev(json);
...
static void
_json_writer_free(struct fbr_json_writer *json) {
	assert_dev(json);
...
static void
_json_writer_debug(struct fbr_fs *fs, struct fbr_json_writer *json)
{
	assert_dev(fs);
...
fbr_store_index(struct fbr_fs *fs, struct fbr_directory *directory)
{
	...
	_json_writer_debug(fs, &json);

	_json_writer_free(&json);
