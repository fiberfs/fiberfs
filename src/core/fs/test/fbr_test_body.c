...
fbr_cmd_fs_test_body(struct fbr_test_context *ctx, struct fbr_test_cmd *cmd)
{
	...
	fbr_body_chunk_append(fs, file, 2, 100, 100, 0, 1);
	fbr_body_chunk_append(fs, file, 3, 200, 100, 0, 1);
	fbr_body_chunk_append(fs, file, 4, 300, 100, 0, 1);
	fbr_body_chunk_append(fs, file, 5, 400, 100, 0, 1);
