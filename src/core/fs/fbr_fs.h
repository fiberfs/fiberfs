...
#define FBR_ENUM_CHUNK_STATE						\
	FBR_ENUM_NAME(fbr_chunk_state)					\
		...
		FBR_ENUM_VALUE(__FBR_CHUNK_STATE_SIZE)			\
	FBR_ENUM_END("ERROR")
...
unsigned long fbr_body_length(struct fbr_file *file, struct fbr_wbuffer *wbuffers);
